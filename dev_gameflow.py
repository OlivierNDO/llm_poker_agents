...
# Create stats tracker and players
stats_tracker = StatsTracker()
player_alice = Player("Alice", 100, AnalyticalAgent())
player_bob = Player("Bob", 100, RandomAgent()) 
player_charlie = Player("Charlie", 100, AnalyticalAgent())
players = [player_alice, player_bob, player_charlie]    
    
    
# Play multiple hands to build stats
for hand_num in range(25):
    hand = Hand(players, stats_tracker)
    hand.play()
