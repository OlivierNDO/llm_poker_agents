...
player_open_ai_gpt_4o = Player(name='Open Ai Gpt-4o', chips=100, agent=LLMAgent(client = open_ai_gpt_4o_client, name='Open Ai Gpt-4o', log_prompts = True))
player_anthropic_claud_sonnet_4_client = Player(name='Claude Sonnet 4', chips=100, agent=LLMAgent(client = anthropic_claud_sonnet_4_client, name='Claude Sonnet 4', log_prompts = True))
player_google_gemini_flash_2_5 = Player(name='Gemini Flash 2.5', chips=100, agent=LLMAgent(client = google_gemini_flash_2_5_client, name='Gemini Flash 2.5', log_prompts = True))
player_llama_3_3_70B_client = Player(name='Llama 3.3 70B', chips=100, agent=LLMAgent(client = llama_3_3_70B_client, name='Llama 3.3 70B', log_prompts = True))
...
config = TableConfig(small_blind=1, big_blind=2, max_hands=3)
